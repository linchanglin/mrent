...
export const Content60DataSource = {
  ...
  img: {
    ...
    className: 'content6-img jt0y6wehx5h-editor_css',
    xs: 24,
    md: 14,
  },
  block: {
...
export const Footer10DataSource = {
  ...
  copyrightPage: { className: 'home-page jt0ue3zc89f-editor_css' },
  copyright: {
    className: 'copyright jt0uehadh4-editor_css',
    children: (
      <span>
